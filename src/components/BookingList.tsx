        ...
        <div>
            {
                ...
                bookItems.data.map((bookItem:BookingItem)=>(
                    <div className="bg-slate-200 rounded px-5 mx-5 py-2 my-2">
                        ...
                        <Button className="block rounded-md bg-sky-600 hover:bg-indigo-600 px-3 py-1 text-white shadow-sm" onClick={()=>removeBooking(bookItem._id)}>remove booking</Button>
                    </div>
