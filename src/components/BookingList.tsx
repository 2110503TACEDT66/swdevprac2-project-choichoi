...
export default async function BookingList(){
    /*const bookItems = await getReservations();
        ...
        <div>
            {
                ...
                bookItems.map((bookItem)=>(
                    <div className="bg-slate-200 rounded px-5 mx-5 py-2 my-2" key={bookItem.id}>
                        ...
                        <Button className="block rounded-md bg-sky-600 hover:bg-indigo-600 px-3 py-1 text-white shadow-sm" onClick={()=>}>remove booking</Button>
                    </div>
